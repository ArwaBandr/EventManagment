...
//    }
    Column(Modifier.fillMaxSize()) {
        ...
        Row(Modifier.fillMaxWidth().padding(top = 7.dp, start = 4.dp, end = 4.dp), horizontalArrangement = Arrangement.SpaceBetween) {
           ...
           if(groupedList.isNotEmpty()){
            ...
            item {
                Column(modifier = Modifier.fillMaxSize(), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
                    Image(painter = painterResource(id = R.drawable.no_tasks_image) , contentDescription = "")
